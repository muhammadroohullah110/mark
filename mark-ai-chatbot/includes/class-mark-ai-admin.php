...
class Mark_AI_Admin {
    ...
    public function enqueue_assets($hook) {
        ...
        wp_enqueue_style('mark-ai-fonts', 'https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@400;500;600;700&family=JetBrains+Mono:wght@400;500&display=swap', [], null);
    ...
    private function render_app_shell($page) {
        ...
        <div id="mark-ai-app" data-page="<?php echo esc_attr($page); ?>" style="background:#050507;border-radius:14px;overflow:hidden;">
            <div style="display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:460px;color:#9AA3AD;gap:18px;background:radial-gradient(800px 400px at 50% 0%, rgba(45,226,230,0.07), transparent 60%);">
                ...
                <span style="font-family:'Space Grotesk',sans-serif;font-size:16px;font-weight:500;color:#9AA3AD;letter-spacing:0.04em;">Loading Mark AI...</span>
            </div>
        </div>
        <style>
